...
import uk.ac.ebi.intact.bridges.wswublast.model.Hit;
...
public class BlastEbiWsTest {
	...
	/**
	 * Test method for {@link AbstractBlastService#submitJob(uk.ac.ebi.intact.bridges.wswublast.model.UniprotAc)}.
	 * 
	...
	public final void testSubmitJobsBadUniprotAc() throws BlastServiceException {
		...
		for (BlastJobEntity jobEntity : jobs) {
			assertNotNull(jobEntity);
			assertEquals(BlastJobStatus.FAILURE, jobEntity.getStatus());
		}
	}
    ...
    public void testFetchAvailableBlast() throws BlastServiceException {
        BlastResult result  =  wsBlast.fetchAvailableBlast(new BlastJobEntity("wswublast-20071102-10414431"));
    }
