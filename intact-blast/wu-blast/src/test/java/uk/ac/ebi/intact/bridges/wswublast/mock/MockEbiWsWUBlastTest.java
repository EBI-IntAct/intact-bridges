...
import uk.ac.ebi.intact.bridges.wswublast.AbstractBlastService;
import uk.ac.ebi.intact.bridges.wswublast.BlastEbiWsTest;
...
public class MockEbiWsWUBlastTest {
    ...
    public final void testSubmitJob() throws BlastServiceException {
        // always throws WuBlastClientException
