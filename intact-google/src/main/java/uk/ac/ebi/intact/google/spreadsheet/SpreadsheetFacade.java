...
public class SpreadsheetFacade {
    ...
    /**
     * Returns the SpreadsheetEntry for the spreadsheet with the given name.
     *
     * @throws java.io.IOException If a network error occurs while trying to communicate with Spreadsheets
     * @throws com.google.gdata.util.ServiceException
     *                             If an application-level protocol error occurs while trying to communicate with Spreadsheets
    ...
    public static SpreadsheetEntry getSpreadsheetWithName( SpreadsheetService service, String name ) throws IOException, ServiceException {
        ...
        throw new IllegalStateException( "You don't have access to a spreadsheet with name: " + name );
    }
